package com.vinay.ipcclient.ui.messenger
...
import com.vinay.ipcclient.*
import com.vinay.ipcclient.databinding.FragmentMessengerBinding
...
class MessengerFragment : Fragment(), ServiceConnection, View.OnClickListener {
    ...
    private fun doBindService() {
        ...
        Intent("messengerexample").also { intent ->
            intent.`package` = "com.vinay.ipcserver"
